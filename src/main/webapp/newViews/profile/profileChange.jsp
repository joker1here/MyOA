                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="${pageContext.request.contextPath}/employee/update" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="userLevel" name="userLevel" readonly unselectable="on" value="${employee.userLevel}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="DeptId" name="DeptId" readonly unselectable="on" value="${employee.dept.deptName}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="JobId" name="JobId" readonly unselectable="on" value="${employee.job.jobName}">
                                </div>
                            </div>
                            <div class="form-group row">
